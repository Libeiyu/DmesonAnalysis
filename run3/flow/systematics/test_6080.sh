#!/bin/bash
export config_modifies="/home/wuct/ALICE/local/DmesonAnalysis/run3/flow/systematics/modifications_config_fit_k6080.yml"
export config_default="/home/wuct/ALICE/local/DmesonAnalysis/run3/flow/config/config_flow_k6080.yml" # bdt cut of corr and uncorr, skip_cut, sysematic
export output_dir="/home/wuct/ALICE/local/Results/BDT/k6080/third/syst"
...
# mkdir -p $output_dir/pre_sys/cutvar_combined
# cp -r ${output_dir}/pre_sys/cutvar_uncorr/ry $output_dir/pre_sys/cutvar_combined/
# cp -r ${output_dir}/pre_sys/cutvar_uncorr/eff $output_dir/pre_sys/cutvar_combined/
